...
impl eframe::App for TemplateApp {
	...
	fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
		...
		egui::CentralPanel::default().show(ctx, |ui| {
			ui.label("Welcome to Mr. Cider microbrewery! Our priorities are waste reduction and ease of use for customers, so you can use this application to figure out the number of moonshine you need.");
			ui.label("To obtain the calibration moonshine, either request it from us, or cook bear meat + corn in a frying pan in an oven.");
			ui.label("Once you know what is your calibration affinity, use it in this form!");
			...
			let combo = egui::ComboBox::from_label(format!("<- Calibration moonshine or Bear + Corn + Pan + Oven gives me ({})", current_bear_meal_affinity)).selected_text(format!("{:?}", selected));
			...
			ui.horizontal(|ui| {
				...
				ui.hyperlink_to("mrcider", "https://github.com/zink-stake/mrcider");
				ui.label("and");
